          ...
          <Card className="bg-green-50 border-green-200">
            ...
            <CardContent>
              ...
              <p className="text-[10px] text-green-600 mt-1">
                {language === 'ko' 
                  ? `당월: ${performanceData.summary.renewalRateDetails?.currentMonthRenewalCount || 0}건 / 전월: ${performanceData.summary.renewalRateDetails?.prevMonthContractCount || 0}건`
                  : `当月: ${performanceData.summary.renewalRateDetails?.currentMonthRenewalCount || 0}件 / 前月: ${performanceData.summary.renewalRateDetails?.prevMonthContractCount || 0}件`
                }
              </p>
            </CardContent>
          </Card>
