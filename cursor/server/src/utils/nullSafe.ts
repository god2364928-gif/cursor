 ...
 */
export function safeString(value: any, defaultValue: string = '未設定'): string {
  // null/undefined 체크
 ...
 */
export function safeStringWithLength(
  value: any, 
 ...
 */
export function firstValidString(values: any[], defaultValue: string = '未設定'): string {
...
export function sanitizeObject<T extends Record<string, any>>(
  ...
  for (const field of fields) {
    ...
    if (value === null || value === undefined || value === '') {
      ...
      sanitized[field] = defaultValue as T[keyof T]
    } else if (typeof value === 'string') {
      const trimmed = value.trim()
      if (trimmed === '' || trimmed === 'null' || trimmed === 'undefined') {
        const defaultValue = defaultValues[field] || '未設定'
        ...
        sanitized[field] = trimmed as T[keyof T]
      }
    }
  }
  return sanitized
