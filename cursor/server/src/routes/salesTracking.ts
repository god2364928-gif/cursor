...
router.post('/bulk-move-to-retargeting', authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
    const { ids } = req.body
...
router.patch('/:id/contact', authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
    const { id } = req.params
...
router.post('/:id/move-to-retargeting', authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
    ...
    try {
      ...
      validateInsertValues(insertValues, [6], {
