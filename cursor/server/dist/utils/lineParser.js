...
exports.parseLineChat = parseLineChat;
exports.formatChatForHistory = formatChatForHistory;
/**
 * LINE 대화 텍스트 파싱
 */
 ...
 */
function extractCompanyName(text, messages) {
 ...
 */
function extractCustomerName(messages, participants) {
 ...
 */
function formatChatForHistory(parsed) {
