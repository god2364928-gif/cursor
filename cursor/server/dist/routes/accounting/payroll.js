...
router.get('/payroll', auth_1.authMiddleware, adminOnly_1.adminOnly, async (req, res) => {
    try {
...
router.post('/payroll/generate', auth_1.authMiddleware, adminOnly_1.adminOnly, async (req, res) => {
    try {
...
router.put('/payroll/:id', auth_1.authMiddleware, adminOnly_1.adminOnly, async (req, res) => {
    try {
        const { id } = req.params;
...
router.delete('/payroll/:id', auth_1.authMiddleware, adminOnly_1.adminOnly, async (req, res) => {
    try {
        const { id } = req.params;
